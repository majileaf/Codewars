...
the person will often die in an instant; When the floor is less than or equal to 6, 
...
const sc = floor => floor < 2 
    ? '' 
    : 'Aa~'.concat([...Array(floor - 2).fill(' Aa~'), ' Pa!', (floor < 7 ? ' Aa!' : '')].join(''));
