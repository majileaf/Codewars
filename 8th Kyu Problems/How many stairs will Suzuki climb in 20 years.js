...
part of a ritual. Some days he climbs more stairs than others depending 
on the number of students he must train in the morning. 

He is curious how many stairs might be climbed over the next 20 years and 
has spent a year marking down his daily progress.
...
// alternatively:
// const stairsIn20 = s => s.reduce((sum, n) => sum + n.reduce((sum, n) => sum + n), 0) * 20;

const stairsIn20 = s => s.flat().reduce((sum, n) => sum + n) * 20;
