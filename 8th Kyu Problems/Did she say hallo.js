...
to keep this a beginner exercise you don't need to check if the greeting is 
a subset of word (Hallowen can pass the test)
...
const validateHello = greetings => {
  ...
  return arr.some(word => greetings.includes(word));
}
