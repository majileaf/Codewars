...
the local law enforcement's breathalizer with his alcoholic breath! Bob feels simply aweful, 
so he wants to make up for it by creating a function that will calculate his blood-alcohol level for them. 
...
const bloodAlcoholContent = (drinks, weight, sex, time) => +(drinks.ounces * drinks.abv * 5.14 / weight * (sex === 'male' ? 0.73 : 0.66) - 0.015 * time).toFixed(4);
