...
algorithm you could use to shift octaves by 8 pitches or something silly like that, 
...
come to code a solution for finding The Loch Ness Monster. 

Note that the phrase can also be written as "3.50" or "three fifty".
*/

// initial solution:
// const isLockNessMonster = s => s.search('3.50') !== -1 || s.search('three fifty') !== -1 || s.search('tree fiddy') !== -1;

const isLockNessMonster = s => ['three fifty', '3.50', 'tree fiddy'].some(word => s.includes(word));

console.log(isLockNessMonster("Your girlscout cookies are ready to ship. Your total comes to three fifty")) // True
console.log(isLockNessMonster("Your girlscout cookies are ready to ship. Your total comes to tree 3.50")) // True
