...
fruits should returns an array of strings where all the rotten fruits are replaced 
by good ones.
...
// initial solution:
// const removeRotten = bagOfFruits => Array.isArray(bagOfFruits) 
//     ? bagOfFruits.map(e => e.includes('rotten') ? e.split('rotten').join('').toLowerCase() : e) 
//     : [];
