...
Only integer amounts will be input, NO floats. This function should output a sequence, where each element in the
array represents the amount of a certain bill type. The array will be set up in this manner:
...
const giveChange = amount => {
    ...
    for (let i = 0; i < bills.length; i++) {
        res.push(Math.floor(amount / bills[i]));
