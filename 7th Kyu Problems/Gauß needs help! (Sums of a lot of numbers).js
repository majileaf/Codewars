...
Advanced - experienced users should try to solve it in one line, without loops, or 
optimizing the code as much as they can.
*/

const f = n => n > 0 && n % 1 === 0 ? n * (n + 1) / 2 : false;
