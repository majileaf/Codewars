...
If one of the condition above is true and the integer is even, add "Script" to the 
end of the string.
...
const caffeineBuzz = n => {
    switch(true) {
        case (n % 12 === 0): return 'CoffeeScript';
        case (n % 6  === 0): return 'JavaScript';
        case (n % 3  === 0): return 'Java';
