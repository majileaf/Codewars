...
Task
Write function max_rot(n) which given a positive integer n returns the maximum number you got
doing rotations similar to the above example.
...
const maxRot = n => {
    ...
    for (let i = 1; i < n.length - 1; i++) {
        ...
        arr.push(arr[current].slice(0, i) + rot(arr[current].slice(i)));
    }
