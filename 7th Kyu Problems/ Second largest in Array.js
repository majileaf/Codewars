...
const secondLargest = array => {
    ...
    if (!Array.isArray(array) || [...new Set(array)].length < 2) return undefined;
    return unique.filter(e => /\d/.test(e)).map(Number).sort((a, b) => b - a)[1];
}
...
console.log(secondLargest("32 11 44 56")) // undefined
