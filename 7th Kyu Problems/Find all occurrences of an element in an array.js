...
in the given array and return another array containing all the index positions of n in the 
given array.
...
// initial solution:
// const findAll = (array, n) => array.reduce((sum, curr, i) => (curr === n ? sum.push(i) : sum, sum), []);

const findAll = (array, n) => array.reduce((sum, curr, i) => curr === n ? [...sum, i] : sum, []);
