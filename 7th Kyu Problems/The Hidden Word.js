/* The Hidden Word
Maya writes weekly articles to a well known magazine, but she is missing one word each time she is about 
to send the article to the editor. The article is not complete without this word. 
...
const hWDic = {6 : "a", 1 : "b", 7 : "d", 4 : "e", 3 : "i", 2 : "l", 9 : "m", 8 : "n", 0 : "o", 5 : "t"};
const hiddenWord = num => [...String(num)].map(e => hWDic[e]).join('');
