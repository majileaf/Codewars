...
Targeted advertising was a bit of a challenge back then. One day, the marketing professor 
at my university told us a story that I am yet to confirm using reliable sources. 
...
alphabet with three letters missing: B, M and W. Needless to say, many were confused, some to the 
...
If data of the wrong data type was sent as a parameter the function must throw an error with the 
following specific message:

new Error("This program only works for text.");
*/

const removeBMW = str => typeof str === 'string' ? str.replace(/[bmw]/gi, '') : new Error("This program only works for text.");

console.log(removeBMW("bmwvolvoBMW")) // "volvo"
console.log(removeBMW("blablahblah")) // "lalahlah"
console.log(removeBMW(1)) // "This program only works for text."