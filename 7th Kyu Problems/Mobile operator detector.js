...
Write a function which accepts number and return name of operator or string "no info", if operator can't be defined. 
...
const detectOperator = a => mobileOp[String(a).slice(1, 4)] || 'no info';
