...
will permit to reach the average navg.
...
const newAvg = (arr, newavg) => {
    const donation = Math.ceil(newavg * (arr.length + 1) - arr.reduce((sum, n) => sum + n, 0));
...
console.log(newAvg([14, 30, 5, 7, 9, 11, 15], 2)) // .to.throw("Expected New Average is too low");