...
const nameScore = name => ({[name]: [...name.toUpperCase()].reduce((sum, n) => sum + (alpha[Object.keys(alpha).find(e => e.includes(n))] || 0), 0)});

var alpha = {'ABCDE':1,'FGHIJ':2,'KLMNO':3,'PQRST':4,'UVWXY':5};
