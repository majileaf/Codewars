...
Task Overview
Complete the function which accepts two strings and calculates the golf score of a game. Both strings will be of length 18, 
and each character in the string will be a number between 1 and 9 inclusive.
*/

const golfScoreCalculator = (parList, scoreList) => [...scoreList].reduce((sum, n, i) => sum + (n - parList[i]), 0);
