...
To determine the number, find the position of the repeated letter in the alphabet (where a is 1, b is 2, ..., z is 26) and 
multiply it by 3.
...
const passTheDoorMan = word => ([...word].find((letter, i) => letter === word[i + 1]).charCodeAt() - 96) * 3;
