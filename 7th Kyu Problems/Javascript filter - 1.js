...
it should output
[ [ "bar_", "bar@bar.com" ] ]
You have to use the filter-method which returns each element of the array for which the filter-method 
returns true.

https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/filter
*/

const searchNames = logins => logins.filter(([loginName, email]) => loginName.endsWith('_'));

const a2 = [ [ "foo", "foo@foo.com" ], [ "bar_", "bar@bar.com" ] ];
console.log(searchNames(a2)) // [ [ "bar_", "bar@bar.com" ] ]