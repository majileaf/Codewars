...
A number can be valid in the following ways:
    ...
    And sometimes you will find numbers with dashes in-between digits or on either side, e.g. "+44--745---487-6120" or 
    "-074-54-87-61-20-". As you can see, dashes may be consecutive.

Good Luck Romeo/Juliette!
*/

const validateNumber = str => /^-*(0|\+44)7-*(\d-*){9}$/.test(str) ? 'In with a chance' : 'Plenty more fish in the sea';
