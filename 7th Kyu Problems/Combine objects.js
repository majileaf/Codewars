...
All input object properties will have only numeric values. Objects 
are combined together so that the values of matching keys are added together.
...
const combine = (...obj) => obj.reduce((sum, n) => (Object.keys(n).map(e => sum[e] = (sum[e] || 0) + n[e]), sum), {});
