...
A geometric sequence is a sequence of numbers that scale by a common ratio, usually denoted as r. 
To get the next term, multiply the current term by this value. The first term is provided for this kata.
...
As an example, the sum of the first 4 terms of the example provided above is 80.
...
const GeometricSequenceSum = (a, r, n) => [...Array(n).keys()].reduce((sum, n) => sum + a * r ** n, 0);
