...
//     let totalRating = 0;
//     for (const rating in meet) {
//         totalRating += rating === boss ? meet[rating] * 2 : meet[rating];
//     }
//     return totalRating / Object.keys(meet).length <= 5 ? 'Get Out Now!' : 'Nice Work Champ!';
// }

const outed = (meet, boss) => Object.keys(meet).reduce((sum, n) => sum + (n === boss ? meet[n] * 2 : meet[n]), 0) / Object.keys(meet).length <= 5 
    ? 'Get Out Now!' 
    : 'Nice Work Champ!';
