...
String.prototype.formatWith = function (...arr) {
    return this.replace(/{(\d)}/g, (char, $1) => arr[$1] || char);
}
...
console.log('Hello {0}. This {1} is bring a {2} to work day'.formatWith('World','Monday','dog')) // 'Hello World. This Monday is bring a dog to work day'
