...
the rest of keys should have a None (JS null)value. If there not enough keys, just 
...
const createDict = (keys, values) => keys.reduce((sum, n, i) => (sum[n] = values[i] !== undefined ? values[i] : null, sum), {});
