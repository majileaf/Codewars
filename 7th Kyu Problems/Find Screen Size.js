/* Find Screen Size
Cheesy Cheeseman just got a new monitor! He is happy with it, but he just discovered that his 
old desktop wallpaper no longer fits. He wants to find a new wallpaper, but does not know which 
size wallpaper he should be looking for, and alas, he just threw out the new monitor's box. 
...
const findScreenHeight = (width, ratio) => {
    ...
    const height = Math.trunc(width / ratioWidth * ratioHeight);
