...
Vowels are left untouched (a remains an a). It's quite hard for an untrained ear to understand a conversation encoded in this manner, 
especially if spoken rapidly.
...
The Assignment
Your task is to implement a function function robberEncode(sentence) which takes in a string sentence and returns the result, 
...
const robberEncode = sentence => sentence.replace(/[B-DF-HJ-NP-TV-Z]/gi, char => char + (/[A-Z]/.test(char) ? 'O' : 'o') + char);
