...
Beware of certain edge cases - for example, 1 is a power of 2 since 2^0 = 1 and 
...
// since above has issues due to floating numbers; rounding:
const isPowerOfTwo = n => (Math.round(Math.log(n) / Math.LN2 * 1e6) / 1e6) % 1 === 0;

// alternatively Math.log2():
