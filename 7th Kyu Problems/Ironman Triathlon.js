...
It consists of a 2.4-mile swim, a 112-mile bicycle ride and a marathon (26.2-mile) (run, raced in that order and without a break. 
It hurts... trust me.
...
const iTri = s => {
    ...
    let race = s < 2.4 ? 'Swim' : s < 114.4 ? 'Bike' : 'Run';
    let dist = s > 130.6 ? 'Nearly there!' : `${(140.6 - s).toFixed(2)} to go!`;
    return {[race] : dist};
}
