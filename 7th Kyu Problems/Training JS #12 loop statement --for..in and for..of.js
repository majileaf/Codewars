...
Although for..in can be used to traverse the array, this is discouraged because in some cases the order 
may be unexpected. So it's recommended that you use another variant for this: for..of (new in ES6). 
...
// alternatively #1:
// const giveMeFive = obj => [].concat(...Object.entries(obj)).filter(e => e.length === 5);

// alternatively #2:
// const giveMeFive = obj => Object.entries(obj).flatMap(e => e).filter(e => e.length === 5);
