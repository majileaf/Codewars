...
const getMissingElement = superImportantArray => 45 - superImportantArray.reduce((sum, n) => sum + n, 0);

// alternatively: 
// const getMissingElement = superImportantArray => superImportantArray.reduce((sum, n) => sum - n, 45);
