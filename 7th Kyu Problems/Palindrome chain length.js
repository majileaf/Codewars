...
Additional info
Some interesting information on the problem can be found in this 
Wikipedia article on Lychrel numbers.
https://en.wikipedia.org/wiki/Lychrel_number
*/

const isPalindrome = n => n === (reverse = Number(String(n).split('').reverse().join('')));
