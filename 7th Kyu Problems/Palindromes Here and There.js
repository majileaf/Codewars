...
Your task is to write a function that returns an array with only 1s and 0s, where all palindromic numbers are replaced 
with a 1 and all non-palindromic numbers are replaced with a 0.
...
const convertPalindromes = numbers => numbers.map(e => +isPalindrome(e));
