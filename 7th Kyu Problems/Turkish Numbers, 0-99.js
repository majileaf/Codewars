...
const getTurkishNumber = (num) => (num < 10 || !(num % 10)) 
    ? turkDic[num] 
    : `${turkDic[Math.floor(num / 10) * 10]} ${turkDic[num % 10]}`;

console.log(getTurkishNumber(1))  // "bir"
console.log(getTurkishNumber(13)) // "on üç"
console.log(getTurkishNumber(27)) // "yirmi yedi"
console.log(getTurkishNumber(38)) // "otuz sekiz"
console.log(getTurkishNumber(77)) // "yetmiş yedi"
console.log(getTurkishNumber(94)) // "doksan dört"