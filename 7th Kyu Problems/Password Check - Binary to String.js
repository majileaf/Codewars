...
His previous developer has left a file on the server with the name password.txt. You open the file and realize 
...
const decodePass = (passArr, bin) => {
  const pass = bin.split(' ').map(e => String.fromCharCode(Number.parseInt(e, 2))).join('');
