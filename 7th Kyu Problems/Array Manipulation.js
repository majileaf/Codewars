...
Your task is to create a function that takes in an array as its argument, manipulates the array as described above, 
then return the resulting array.

Note: Return a new array, rather than modifying the passed array.
*/

const arrayManip = array => array.map((e, i) => {
        const arr = [...new Set(array.slice(i))].sort((a, b) => a - b);
        return arr[arr.indexOf(e) + 1] || -1;
    });
