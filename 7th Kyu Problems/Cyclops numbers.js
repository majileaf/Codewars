...
101
11111111011111111
You must take an input, n, that will be in decimal format (base 10), then return True if that number wil be 
a cyclops number when converted to binary, or False if it won't.
...
const cyclops = n => {
    n = n.toString(2);
    if (n.length % 2 === 0 || n[Math.floor(n.length / 2)] === '1') return false;
