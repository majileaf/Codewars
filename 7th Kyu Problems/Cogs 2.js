...
console.log(cogRpm([77, 54, 47, 51, 81, 79, 62, 40, 48, 28, 66, 70, 76], 2)) // [0.6103896103896104, 1.6382978723404256]
console.log(cogRpm([80, 38, 87, 28, 71, 58, 94, 74, 98, 68, 19, 54, 67, 97, 87], 1)) // [-0.475, -2.1052631578947367]
console.log(cogRpm([65, 14, 100, 53, 73, 20, 73,  39, 74, 14], 2)) // [1.5384615384615385, -0.6499999999999999]
console.log(cogRpm([77, 54, 18, 29, 94, 60, 90, 92, 32, 92, 42], 1)) // [-0.7777777777777777, -1.2857142857142858]
console.log(cogRpm([20, 69], 0)) // [3.4499999999999997, -0.2898550724637681]