...
const rotate = (data, n) => data.map((_, i) => data[(data.length - n % data.length + i) % data.length]);
...
console.log(rotate([1, 2, 3, 4, 5], 4)) // [2, 3, 4, 5, 1]
console.log(rotate([1, 2, 3, 4, 5], -4)) // [5, 1, 2, 3, 4]
console.log(rotate([1, 2, 3, 4, 5], 5)) // [1, 2, 3, 4, 5]
console.log(rotate([1, 2, 3, 4, 5], -5)) // [1, 2, 3, 4, 5]
console.log(rotate([1, 2, 3, 4, 5], 6)) // [5, 1, 2, 3, 4]
console.log(rotate([1, 2, 3, 4, 5], -6)) // [2, 3, 4, 5, 1]
console.log(rotate([true, true, false], 2)) // [true, false, true]
console.log(rotate([1, 2, 3, 4, 5], 12478)) // [3, 4, 5, 1, 2]
console.log(rotate(["a", "b", "c"], 2)) // ["b", "c", "a"]
console.log(rotate([], 976999)) // []