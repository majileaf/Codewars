...
the given number is a Narcissistic number in base 10. This may be True and False in 
your language, e.g. PHP.
...
//     .toString()
//     .split('')
//     .reduce((sum, n) => sum + n ** value.toString().length, 0) 
//     === value;

const narcissistic = value => value
    .toString()
    .split('')
    .reduce((sum, n, arr) => sum + n ** arr.length, 0) 
    === value;
