...
const sumParts = (array, partial) => array.slice(partial[0], partial[1] + 1).reduce((sum, n) => sum + n, 0);
const maxSum = (arr, range) => range.reduce((sum, n) => Math.max(sum, sumParts(arr, n)), -Infinity);
