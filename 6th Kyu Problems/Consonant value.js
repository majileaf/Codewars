...
//       arr.push(str.slice(0, str.indexOf(s[i])));
//       str = str.slice(str.indexOf(s[i]) + 1);
//     }
//   }
//   arr.push(str);

//   return Math.max(...arr.map(e => [...e].reduce((sum, n) => sum + n.charCodeAt() - 96, 0)));
// }

const solve = s => Math.max(...s.split(/[aeiou]/g).map(e => [...e].reduce((sum, n) => sum + n.charCodeAt() - 96, 0)))
