/* String subpattern recognition IString subpattern recognition I
...
Strings will never be empty and can be composed of any character (just consider upper- and lowercase letters as 
different entities) and can be pretty long (keep an eye on performances!).
*/

const hasSubpattern = string => /^(\w+)\1+$/g.test(string);
